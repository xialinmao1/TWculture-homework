...
会议内容：DEV（Developer，开发人员）自己先完整地过一遍 Story 的描述；
...
有点类似于测试驱动开发。因此，在敏捷测试中，测试人员不仅仅只是产品的验证者，更是产品质量保证和提高，及时交付的责任者。测试的参与无处不在。结合此次培训中提到的，每一个冲刺阶段都要交付该阶段的产品，那么引用测试比较广泛的一句话>测试应该尽早的参与项目，越早参与，风险越小。

因此，作为测试人员，我感觉敏捷开发是一种适应当下互联网开发特性的开发模式，并且通过将项目周期大而化小，使得每一阶段、每一个角色的目标非常明确，更能提高工作效率，并且保证产品质量。
